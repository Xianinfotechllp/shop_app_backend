...
const { addToCartController,updateCartProductQuantityController ,getCartController, removeCartItemController } = require("../controller/cart.controller");
const { verifyToken } = require("../middleware/verifyToken");

router.post('/add', verifyToken, addToCartController);
router.put('/update-quantity/:productId', verifyToken, updateCartProductQuantityController);
